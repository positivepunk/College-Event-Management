...
(1, 'Crypto quiz', 500, 1, 'images\\crypto.jpg', 1);
...
(1, '2024-02-20', '5pm', 'seminar hall hitech');
...
('1ms21cs405', 'Ravikumar L', 'cse', 8, 'rut@ffghtdd.com', '8095848183', 'rit', 1);
...
--
ALTER TABLE `event_info`
  MODIFY `event_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
...
--
ALTER TABLE `staff_coordinator`
  MODIFY `stid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
